...
namespace FSWDFinalProject.UI.MVC.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReservationId,UserAssetId,LocationId,ReservationDate")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReservationId,UserAssetId,LocationId,ReservationDate")] Reservation reservation)
        {
            if (ModelState.IsValid)
            {
