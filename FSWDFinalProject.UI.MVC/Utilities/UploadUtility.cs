...
namespace FSWDFinalProject.UI.MVC.Utilities
{
    ...
    public class UploadUtility
    {
        ...
        public static void ResizeImage(string savePath, string fileName, Image image, int maxImgSize, int maxThumbSize) //Use these to adjust image sizes
        {
